...
#include "aircraft_msgs/msg/detail/aircraft_state__rosidl_typesupport_fastrtps_c.h"
...
using _AircraftState__ros_msg_type = aircraft_msgs__msg__AircraftState;
...
{
  const _AircraftState__ros_msg_type * ros_message = static_cast<const _AircraftState__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aircraft_msgs__msg__AircraftState;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const aircraft_msgs__msg__AircraftState * ros_message = static_cast<const aircraft_msgs__msg__AircraftState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_aircraft_msgs__msg__AircraftState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  aircraft_msgs__msg__AircraftState * ros_message = static_cast<aircraft_msgs__msg__AircraftState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_aircraft_msgs__msg__AircraftState(cdr, ros_message);
}

static uint32_t _AircraftState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aircraft_msgs__msg__AircraftState(
...
static size_t _AircraftState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aircraft_msgs__msg__AircraftState(
...
static message_type_support_callbacks_t __callbacks_AircraftState = {
  "aircraft_msgs::msg",
  "AircraftState",
...
static rosidl_message_type_support_t _AircraftState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AircraftState,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aircraft_msgs, msg, AircraftState)() {
  return &_AircraftState__type_support;
}
